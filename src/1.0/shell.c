...
static void sh_desktop(void)
{
    ...
    vga_write_at(y0 + 5, x0 + 2, "64 comandos do sistema.", 0x00, 0x07);
...
static void cmd_help(void)
{
    ...
    console_puts("head wc grep hexdump\n");
...
void shell_run(void)
{
    ...
    sh_desktop();
    console_puts("built 0.13.0 (/bin/built) - 'help' lista 64 comandos.\n");
